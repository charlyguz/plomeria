...
const DashboardTecnico = () => {
  ...
  const handleSeleccionarSolicitud = async (solicitud) => {
    ...
    try {
      const response = await axios.get(`https://plomeria-backend.azurewebsites.net/api/servicios/${solicitud.ID_Servicio}/progreso`, { withCredentials: true });
  ...
  const handleSolicitarMateriales = async () => {
    if (!tareasCompletadas.recogerMateriales) {
      ...
      await axios.post(`https://plomeria-backend.azurewebsites.net/api/servicios/${reparacionEnCurso.ID_Servicio}/materiales`, { materiales: materialesParaEnviar }, { withCredentials: true });
  ...
  const handleConcluirTrabajo = async () => {
    ...
    try {
      await axios.put(`https://plomeria-backend.azurewebsites.net/api/servicios/${reparacionEnCurso.ID_Servicio}`, formData, {
        headers: {
  ...
  const actualizarEstadoServicio = async (idServicio, estado) => {
    try {
      await axios.put(`https://plomeria-backend.azurewebsites.net/api/servicios/${idServicio}`, {
        estado
      }, { withCredentials: true });
  ...
  const actualizarProgresoServicio = async (idServicio, progreso) => {
    try {
      await axios.put(`https://plomeria-backend.azurewebsites.net/api/servicios/${idServicio}/progreso`, progreso, { withCredentials: true });
    } catch (error) {
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get('https://plomeria-backend.azurewebsites.net/api/servicios', {
        withCredentials: true
      });
